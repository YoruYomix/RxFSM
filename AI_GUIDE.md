# RxFSM — AI Code Generation Reference
...
- **Triggers are `readonly struct`** — they carry data at the moment they fire and are zero-allocation when used with `Trigger<TTrigger>`.
